...
| `autopilot`, `auto pilot`, `auto-pilot`, `autonomous`, `build me`, `I want a`, `create me`, `make me`, `handle it all`, `full auto`, `fullsend`, `end to end`, `e2e this` | autopilot | Fully autonomous execution |
...
| `deep interview`, `ouroboros`, `socratic` | deep-interview | Socratic deep interview |
